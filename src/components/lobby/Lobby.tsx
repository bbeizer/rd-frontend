      ...
      <div className="lobby">
        ...
        <div className="rules">
          ...
          <div className="section">
            ...
            <p>
              The piece you select will be highlighted in blue. Click a piece to select it, then
              click a valid square to move. Valid squares are highlighted in red.
            </p>
            <div className="animation-container">
              <img
                src="/images/startingPiece.png"
                alt="Starting Piece"
          ...
          <div className="section">
            ...
            <ul>
              ...
              <li>
                The piece holding the ball cannot move but can pass the ball to another piece.
              </li>
            </ul>
            <div className="image-container">
      ...
      {showFeedbackModal && (
        <Modal>
          ...
          <div style={{ marginTop: '1rem' }}>
            <button className="button" onClick={handleSubmitFeedback} disabled={isSubmitting}>
          ...
          {submitSuccess && (
            <p style={{ marginTop: '1rem', color: 'green' }}>Thank you for your feedback!</p>
          )}
        </Modal>
      )}
    </div>
